...
<body>
	...
	<form action="form04_process.jsp" method="post">
		...
		<label>취미 : </label>
		<input type="checkbox" id="hobby1" name="hobby1" value="독서" checked >독서
		<input type="checkbox" id="hobby2" name="hobby2" value="운동" >운동
		<input type="checkbox" id="hobby3" name="hobby3" value="영화" >영화
		<br>
